...
public class EvolutionTest {
    ...
    public void testDecideStage_EggStage() {
        ...
        assertEquals(Evolution.Stage.CRACKED_EGG, Evolution.decideStage(3, Evolution.Stage.EGG));
    }
    ...
    public void testDecideStage_CrackedEggStage() {
        ...
        assertEquals(Evolution.Stage.HATCHING, Evolution.decideStage(5, Evolution.Stage.CRACKED_EGG));
    }
    ...
    public void testDecideStage_HatchingStage() {
        ...
        assertEquals(Evolution.Stage.DUCKLING, Evolution.decideStage(8, Evolution.Stage.HATCHING));
    }
    ...
    public void testDecideStage_DucklingStage() {
        ...
        assertEquals(Evolution.Stage.MATCHING, Evolution.decideStage(13, Evolution.Stage.DUCKLING));
    }
    ...
    public void testDecideStage_MatchingStage() {
        ...
        assertEquals(Evolution.Stage.MARRIED, Evolution.decideStage(21, Evolution.Stage.MATCHING));
    }
    ...
    public void testDecideStage_MarriedStage() {
        ...
        assertEquals(Evolution.Stage.BIRTH, Evolution.decideStage(34, Evolution.Stage.MARRIED));
    }
